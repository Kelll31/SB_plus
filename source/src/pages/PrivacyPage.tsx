  ...
  return (
    <div className="pt-24 md:pt-32 pb-20 md:pb-24">
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <h1 className="section-title mb-12">Политика конфиденциальности</h1>
          <div className="space-y-8 text-industrial-text-muted leading-relaxed">
            <section>
              <h2 className="text-xl font-bold text-white uppercase tracking-tight mb-4">1. Общие положения</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-white uppercase tracking-tight mb-4">2. Основные понятия</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-white uppercase tracking-tight mb-4">3. Цели обработки</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-white uppercase tracking-tight mb-4">4. Правовые основания</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-bold text-white uppercase tracking-tight mb-4">5. Безопасность</h2>
              <p>
